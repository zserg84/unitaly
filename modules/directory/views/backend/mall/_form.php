    ...
    <div class="row">
        <div class="col-sm-6">
            <?= $form->field($formModel, 'province_id')->widget(DepDrop::classname(), [
                ...
                'pluginOptions'=>[
                    'depends'=>['shopmallform-region_id'],
    ...
    <div class="row">
        <div class="col-sm-6">
            <?= $form->field($formModel, 'city_id')->widget(DepDrop::classname(), [
                ...
                'pluginOptions'=>[
                    'depends'=>['shopmallform-region_id', 'shopmallform-province_id'],
        ...
        <div class="col-sm-2">
            <div style="padding-top: 27px">
                ...
                echo GoogleMap::widget([
                    'id_latitude' => 'shopmallform-latitude',
                    'id_longitude' => 'shopmallform-longitude',
