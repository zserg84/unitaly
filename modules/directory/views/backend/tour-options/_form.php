...
<?php endif; ?>
	<div class="row">
		<div class="col-sm-6">
			<?=$form->field($formModel, 'service_type_id')->dropDownList(ArrayHelper::map(ServiceType::find()->tour()->all(), 'id', 'name'), [
				'prompt' => $formModel->getAttributeLabel('service_type_id'),
			])?>
		</div>
	</div>
<?
