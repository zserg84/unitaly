    ...
    <div class="row">
        <div class="col-sm-6">
            <?= $form->field($formModel, 'province_id')->widget(DepDrop::classname(), [
                ...
                'pluginOptions'=>[
                    'depends'=>['shopmarketform-region_id'],
    ...
    <div class="row">
        <div class="col-sm-6">
            <?= $form->field($formModel, 'city_id')->widget(DepDrop::classname(), [
                ...
                'pluginOptions'=>[
                    'depends'=>['shopmarketform-region_id', 'shopmarketform-province_id'],
        ...
        <div class="col-sm-2">
            <div style="padding-top: 27px">
                ...
                echo GoogleMap::widget([
                    'id_latitude' => 'shopmarketform-latitude',
                    'id_longitude' => 'shopmarketform-longitude',
